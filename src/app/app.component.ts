...
export class AppComponent {
  ...
  builds : Build[] = [];
  selectedBuild: Build[] = [];
  public columns = ['Build_ID', 'Portfolio_Name', 'ValueStream_Name', 'CI_Application_Name', 'Test_Environment', 'Test_Type', 'Start_DateTimeStamp', 'Build_Status','RCA_Review_Status'];
  selectedBuildId="";
